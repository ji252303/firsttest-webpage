...
var util = require('./util'); // passport와 passport-local package는 index.js에 rqeurie 되지 않고
...
const da = "mongodb://127.0.0.1/usersDB"
mongoose.connect(da, { useNewUrlParser: true, useUnifiedTopology: true}); // MONGO_DB 환경변수에 URL 저장되어있음.
